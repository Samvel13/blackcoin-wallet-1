...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("blackcoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No BlackCoin application found.\nPlease install BlackCoin Wallet.", Toast.LENGTH_LONG).show();
